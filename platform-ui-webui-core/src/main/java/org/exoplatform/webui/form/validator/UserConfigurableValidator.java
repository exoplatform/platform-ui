...
public class UserConfigurableValidator extends MultipleConditionsValidator {
    ...
    protected void validate(String value, String label, CompoundApplicationMessage messages, UIFormInput uiInput) {
        ...
        if (configuration == null) {
            ...
            } else if (IDENTIFIER.equals(validatorName)) {
               IdentifierValidator.validate(value, label, messages, uiInput, IdentifierValidator.DEFAULT_MIN_LENGTH, IdentifierValidator.DEFAULT_MAX_LENGTH);
            }
        } else {
    ...
    private static class ValidatorConfiguration {
        ...
        private ValidatorConfiguration(String propertyKey, Properties properties) {
            ...
            if (USERNAME.equals(propertyKey)) {
                ...
                minLength = minProperty != null ? Integer.valueOf(minProperty) : IdentifierValidator.DEFAULT_MIN_LENGTH;
                maxLength = maxProperty != null ? Integer.valueOf(maxProperty) : IdentifierValidator.DEFAULT_MAX_LENGTH;
                pattern = properties.getProperty(prefixedKey + ".regexp", IdentifierValidator.IDENTIFER_VALIDATOR_REGEX);
            } else {
